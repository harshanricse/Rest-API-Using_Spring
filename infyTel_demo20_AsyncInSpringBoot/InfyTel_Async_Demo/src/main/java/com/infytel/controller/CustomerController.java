...
public class CustomerController {
	...
	@PostMapping("/addListOfCust")//for adding multiple customers at a time
	...
	@GetMapping("/sendOfferMails")
	public String sendFestiveOfferMail(){
		custServ.sendFestiveOfferMail();
		return "Mails sent succesfully"+Thread.currentThread().getName();
	}
