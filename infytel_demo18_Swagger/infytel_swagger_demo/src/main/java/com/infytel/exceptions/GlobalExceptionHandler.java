...
public class GlobalExceptionHandler {
	...
	@ExceptionHandler(ConstraintViolationException.class) // Handler for validation failures w.r.t URI parameters
	...
	@ExceptionHandler(MethodArgumentNotValidException.class) // Handler for validation failures w.r.t DTOs
